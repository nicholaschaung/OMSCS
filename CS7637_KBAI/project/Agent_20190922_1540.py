...
class Agent:
    ...
    def Solve(self, problem):
        ...
        if problem.problemType == '2x2':
            ...
            if solvedByBasic == False:
                ...
                answerFromABpixel = self.findAnswer(problem, imageDfromABpixel, answers, 0.04)
                #print(answerFromABpixel)
                answerFromACpixel = self.findAnswer(problem, imageDfromACpixel, answers, 0.04)
    ...
    def diffLogicBasic(self, image1, image2, tolerance=0.03):
    ...
    def findAnswer(self, problem, image, answers, tolerance):
        ...
        for af in answerFiles:
            ...
            rel = self.diffLogicBasic(image, imageAnswer, tolerance)
            if rel == 'exact':
                count += 1
                answer.append(af)
